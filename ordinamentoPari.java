public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Posizione del primo numero dispari: " + unici);

        // Stampa i numeri dispari presenti nell'array
        System.out.println("Numeri dispari:");
        for (int i = unici; i < vet1.length; i++) {
            // Aggiungi un controllo per evitare di stampare duplicati
            if (i == unici || vet1[i] != vet1[i - 1]) {
